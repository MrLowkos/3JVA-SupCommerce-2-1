						...
						+ "<div class=\"container\">"
							+ "<header class=\"navbar-header\">"
								+ "<button class=\"navbar-toggle collapsed\" data-target=\".navbar-collapse\" data-toggle=\"collapse\" type=\"button\">"
									...
									+ "<span class=\"icon-bar\"></span>"
								+ "</button>"
								+ "<a class=\"navbar-brand\" href=\"/SupCommerce-2-1\">SupCommerce 2.1</a>"
							+ "</header>"
							+ "<nav class=\"navbar-collapse collapse\" style=\"height: 0.8px;\">"
								+ "<ul class=\"nav navbar-nav\">"
									+ "<li><a href=\"/SupCommerce-2-1\"><span class=\"glyphicon glyphicon-home\"></span>&nbsp; Home</a></li>"
									+ "<li><a href=\"/SupCommerce-2-1/listProduct\"><span class=\"glyphicon glyphicon-list\"></span>&nbsp; Products List</a></li>"
									+ "<li class=\"active\"><a href=\"/SupCommerce-2-1/basicInsert\"><span class=\"glyphicon glyphicon-random\"></span>&nbsp; Random Product</a></li>"
								+ "</ul>"
							+ "</nav>"
						+ "</div>"
					+ "</div>"
							...
							+ "<div class=\"col-sx-12 col-sm-6 col-md-4 col-lg-3\">"
								+ "<article class=\"panel panel-primary\">"
									+ "<header class=\"panel-heading\">"
										+ "<h3><a style=\"color: #FFF;\" href=\"/SupCommerce-2-1/showProduct?id=" + Long.toString(product.getId()) + "\"><span class=\"glyphicon glyphicon-tag\"></span>&nbsp; Product Id " + Long.toString(product.getId()) + "</a></h3>"
									+ "</header>"
