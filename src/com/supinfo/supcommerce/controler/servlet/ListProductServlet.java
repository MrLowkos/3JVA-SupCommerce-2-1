 						...
 						+ "<div class=\"container\">"
 							...
 							+ "<nav class=\"navbar-collapse collapse\" style=\"height: 0.8px;\">"
 								+ "<ul class=\"nav navbar-nav\">"
 									...
 									+ "<li class=\"active\"><a href=\"/SupCommerce-2-1/listProduct\"><span class=\"glyphicon glyphicon-list\"></span>&nbsp; Products List</a></li>"
 									+ "<li><a href=\"/SupCommerce-2-1/basicInsert\"><span class=\"glyphicon glyphicon-random\"></span>&nbsp; Random Product</a></li>"
 								+ "</ul>"
 							+ "</nav>"
 						+ "</div>"
 					+ "</div>"
									...
									out.println(
										...
										+ "<article class=\"panel panel-primary\">"
											+ "<header class=\"panel-heading\">"
												...
												+ "<h3><a style=\"color: #FFF;\" href=\"/SupCommerce-2-1/showProduct?id=" + Long.toString(p.getId()) + "\">"
